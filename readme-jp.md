...
- 20210317:  
I wont upgrade anything until it will be nacessary to do(likes apple changed their secure boot policy,so you have to use latest opencore to boot etc.),it still works well on even lastest version of macos 11.2.3(when i wrote this). so,see you in next nacessary-upgrade version.  
